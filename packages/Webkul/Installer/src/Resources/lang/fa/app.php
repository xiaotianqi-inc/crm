    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'anahisoft'       => 'نصب کرایین',
                'anahisoft-info'  => 'در حال ایجاد جداول پایگاه داده، این ممکن است چند لحظه طول بکشد',
                'title'        => 'نصب',
            ],

            'installation-completed' => [
                'admin-panel'                => 'پنل مدیریت',
                'anahisoft-forums'              => 'انجمن کرایین',
                'customer-panel'             => 'پنل مشتری',
                'explore-anahisoft-extensions'  => 'کاوش افزونه‌های کرایین',
                'title'                      => 'نصب کامل شد',
            ...
            'back'                     => 'بازگشت',
            'anahisoft'                   => 'کرایین',
            'anahisoft-info'              => 'یک پروژه اجتماعی توسط',
            'anahisoft-logo'              => 'لوگوی کرایین',
            'continue'                 => 'ادامه',

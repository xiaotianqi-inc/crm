    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'anahisoft'       => 'Instalación de Anahisoft',
                'anahisoft-info'  => 'Creando las tablas de la base de datos, esto puede tardar unos momentos',
                'title'        => 'Instalación',
            ],

            'installation-completed' => [
                'admin-panel'                => 'Panel de Administración',
                'anahisoft-forums'              => 'Foro de Anahisoft',
                'customer-panel'             => 'Panel de Clientes',
                'explore-anahisoft-extensions'  => 'Explorar Extensiones de Anahisoft',
                'title'                      => 'Instalación Completada',
                'title-info'                 => 'Anahisoft se ha instalado correctamente en su sistema.',
            ],

            'ready-for-installation' => [
                'create-databsae-table'   => 'Crear tabla de base de datos',
                'install'                 => 'Instalación',
                'install-info'            => 'Anahisoft Para la Instalación',
            ...
            'start' => [
                ...
                'title'         => 'Instalación de Anahisoft',
                'welcome-title' => 'Bienvenido a Anahisoft',
            ],
            ...
            'back'                     => 'Atrás',
            'anahisoft'                   => 'Anahisoft',
            'anahisoft-info'              => 'un Proyecto Comunitario de',
            'anahisoft-logo'              => 'Logotipo de Anahisoft',
            'continue'                 => 'Continuar',
            'installation-description' => 'La instalación de Anahisoft generalmente implica varios pasos. Aquí hay un esquema general del proceso de instalación de Anahisoft.',

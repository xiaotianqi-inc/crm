    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'anahisoft'       => 'تثبيت Anahisoft',
                'anahisoft-info'  => 'إنشاء جداول قاعدة البيانات، وقد يستغرق ذلك بضع دقائق',
                'title'        => 'التثبيت',
            ],

            'installation-completed' => [
                'admin-panel'                => 'لوحة المشرف',
                'anahisoft-forums'              => 'منتديات Anahisoft',
                'customer-panel'             => 'لوحة العميل',
                'explore-anahisoft-extensions'  => 'استكشاف امتدادات Anahisoft',
                'title'                      => 'اكتمال التثبيت',
                'title-info'                 => 'تم تثبيت Anahisoft بنجاح على نظامك.',
            ],

            'ready-for-installation' => [
                'create-databsae-table'   => 'إنشاء جدول قاعدة البيانات',
                'install'                 => 'التثبيت',
                'install-info'            => 'Anahisoft للتثبيت',
            ...
            'start' => [
                ...
                'title'         => 'تثبيت Anahisoft الخاص بك',
                'welcome-title' => 'مرحبًا بك في Anahisoft',
            ],
            ...
            'back'                     => 'رجوع',
            'anahisoft'                   => 'Anahisoft',
            'anahisoft-info'              => 'مشروع مجتمعي من قبل',
            'anahisoft-logo'              => 'شعار Anahisoft',
            'continue'                 => 'متابعة',
            'installation-description' => 'عادة ما تتضمن عملية تثبيت Anahisoft عدة خطوات. إليك نظرة عامة عامة على عملية التثبيت anahisoft',
            'installation-info'        => 'نحن سعداء برؤيتك هنا!',
            'installation-title'       => 'مرحبًا بك في التثبيت',
            'installation-wizard'      => 'لغة معالج التثبيت',
            'title'                    => 'مثبت Anahisoft',
            'webkul'                   => 'Webkul',
        ],
    ],
];

    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'anahisoft'       => 'Instalação do Anahisoft',
                'anahisoft-info'  => 'Criando as tabelas do banco de dados, isso pode levar alguns momentos',
                'title'        => 'Instalação',
            ],

            'installation-completed' => [
                'admin-panel'                => 'Painel de Administração',
                'anahisoft-forums'              => 'Fórum Anahisoft',
                'customer-panel'             => 'Painel do Cliente',
                'explore-anahisoft-extensions'  => 'Explorar Extensões Anahisoft',
                'title'                      => 'Instalação Concluída',
                'title-info'                 => 'Anahisoft foi instalado com sucesso no seu sistema.',
            ],
            ...
            'start' => [
                ...
                'title'         => 'Instalação do Anahisoft',
                'welcome-title' => 'Bem-vindo ao Anahisoft',
            ],
            ...
            'back'                     => 'Voltar',
            'anahisoft'                   => 'Anahisoft',
            'anahisoft-info'              => 'um projeto comunitário de',
            'anahisoft-logo'              => 'Logotipo Anahisoft',
            'continue'                 => 'Continuar',
            'installation-description' => 'A instalação do Anahisoft geralmente envolve várias etapas. Aqui está uma visão geral do processo de instalação do Anahisoft',

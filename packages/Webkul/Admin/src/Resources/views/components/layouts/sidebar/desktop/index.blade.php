                                ...
                                <div class="journal-scroll h-[calc(100vh-100px)] overflow-hidden">
                                    <nav class="grid w-full gap-2">
                                        ...
                                        <div class="px-4 group/item {{ $menuItem->isActive() ? 'active' : 'inactive' }}">
                                            ...
                                            >
                                                @php
                                                    $subMenuName = core()->getConfigData('general.settings.menu.'.$subMenuItem->getKey()) 
                                                                ?? $subMenuItem->getName(); // o usa ('admin::app.menu.' . $subMenuItem->getKey()) si el nombre por defecto es texto en inglés simple
                                                @endphp
